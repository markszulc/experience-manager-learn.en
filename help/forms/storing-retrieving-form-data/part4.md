            ...
            success: function(guideResultObject) {
                ...
                xhr.onload = function(e) {
                    ...
                    if (this.status == 200) {
                        ...
                        linktext.value = window.location.protocol + "://" + window.location.hostname + ":" + window.location.port + "/content/dam/formsanddocuments/demostoreandretrieveformdata/jcr:content?wcmmode=disabled&guid=" + jsonResponse.guid;
